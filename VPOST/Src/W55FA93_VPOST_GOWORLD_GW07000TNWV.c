/**************************************************************************//**
 * @file     W55FA93_VPOST_GOWORLD_GW07000TNWV.c
 * @version  V3.00
...
void GOWORLD_GW07000GNWV_Init(void)
{
...
INT vpostLCMInit_GOWORLD_GW07000GNWV(PLCDFORMATEX plcdformatex, UINT32 *pFramebuf)
{
	volatile S_DRVVPOST_SYNCLCM_WINDOW sWindow = {800,480,800};	
//	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {3,0x2b,(UINT8)0xf2};
	volatile S_DRVVPOST_SYNCLCM_HTIMING sHTiming = {3,0x2b,(UINT8)0x11};
	volatile S_DRVVPOST_SYNCLCM_VTIMING sVTiming = {0x8,0x11,8};
...
//	u32PLLclk = sysGetPLLOutputKhz(eSYS_UPLL, 27000);	// CLK_IN = 27 MHz
	...
	u32ClockDivider = u32PLLclk / 33000;		
...
INT32 vpostLCMDeinit_GOWORLD_GW07000GNWV(VOID)
{
	vpostVAStopTrigger();
	vpostFreeVABuffer();
...
#endif    //HAVE_GOWORLD_GW07000GNWV