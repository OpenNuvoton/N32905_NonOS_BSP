/**************************************************************************//**
 * @file     Smpl_FSC_GC032A.c
 * @brief    Initialize GC032A sample code
 *
...
struct OV_RegValue g_sGC032A_RegValue[] = 
{
#ifdef __GNUC__
    #include "GC032A/GC032A_Init.dat"
#else
    #include "GC032A\GC032A_Init.dat"
#endif
};
...
{//8 bit slave address, 8 bit data. 
	{g_sGC032A_RegValue,	_REG_TABLE_SIZE(g_sGC032A_RegValue)},

	{0, 0}
};


struct OV_RegValue g_sGC032A_50Hz_RegValue[] = 
{
#ifdef __GNUC__
    #include "GC032A/GA032A_50Hz_Banding.dat"
#else
    #include "GC032A\GA032A_50Hz_Banding.dat"
#endif
};
struct OV_RegValue g_sGC032A_60Hz_RegValue[] = 
{
#ifdef __GNUC__
    #include "GC032A/GA032A_60Hz_Banding.dat"
#else
    #include "GC032A\GA032A_60Hz_Banding.dat"
#endif
};
static struct OV_RegTable g_OV_BandingTable[] =
{//8 bit slave address, 8 bit data. 
     {g_sGC032A_50Hz_RegValue,	_REG_TABLE_SIZE(g_sGC032A_50Hz_RegValue)},
     {g_sGC032A_60Hz_RegValue,	_REG_TABLE_SIZE(g_sGC032A_60Hz_RegValue)}, 
};
...
VOID GC032A_Init(UINT32 nIndex)
{
	UINT32 u32Idx;
	UINT32 u32TableSize;
	UINT8  u8DeviceID;
...
#ifdef __50HZ__	
	u32TableSize = g_OV_BandingTable[0].u32TableSize;
	psRegValue = g_OV_BandingTable[0].sRegTable;
#endif
#ifdef __60HZ__	
	u32TableSize = g_OV_BandingTable[1].u32TableSize;
	psRegValue = g_OV_BandingTable[1].sRegTable;
#endif
...
=====================================================================*/
#ifndef UDC
UINT32 Smpl_GC032A(UINT8* pu8FrameBuffer0, UINT8* pu8FrameBuffer1, UINT8* pu8FrameBuffer2)
#else
UINT32 Smpl_GC032A(UINT8* pu8FrameBuffer0, UINT8* pu8FrameBuffer1)
#endif
{
