...
BOOL volatile bWaitUSB = FALSE;

BOOL volatile g_bWaitVIN = 0;

/* VideoIN Buffer index */
volatile UINT32 u32VideoInIdx = 0;

/* Skip Frame number */
UINT32 u32SkipFrame = 0;

extern BOOL volatile gOneField;
...
UINT32 jpegEncode(UINT32 u32YAddress,UINT32 u32BitstreamAddress, UINT16 u16Width,UINT16 u16Height)
{
	    ...
	    if(gOneField)
		{
	    	...
	    	jpegIoctl(JPEG_IOCTL_SET_DIMENSION, u16Height/2, u16Width);	
		    //Set Encode Source Image Height        
    		jpegIoctl(JPEG_IOCTL_SET_SOURCE_IMAGE_HEIGHT, u16Height/2, 0);
			jpegIoctl(JPEG_IOCTL_SET_ENCODE_UPSCALE, u16Height, u16Width); 	
